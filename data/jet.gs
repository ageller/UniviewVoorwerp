...
void main()
{
	...
	mat3 rotX = rotationMatrix(vec3(1,0,0), userRotationX);//userRotationX); 
	mat3 rotY = rotationMatrix(vec3(0,1,0), userRotationY);//userRotationY);
	mat3 rotZ = rotationMatrix(vec3(0,0,1), userRotationZ);//userRotationZ);
